...
def claims() -> list[Claim]:
    ...
    return [
        ...
        Claim("§2/§11", "OpenClaw allowFrom = ['+13058495648', '+526623538272'] (Cynthia + Daniel)",
              "openclaw.json channels.whatsapp.allowFrom",
              lambda: ((sorted(openclaw_json().get("channels", {}).get("whatsapp", {}).get("allowFrom", [])) == ['+13058495648', '+526623538272']),
